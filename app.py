...
from routers.masterSettings.lofBuisness import router as lofbuisness_router
...
app.include_router(lofbuisness_router, prefix="/api/lof-buisness", tags=["lof-buisness"])
